            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="judul" class="col-md-6 col-form-label text-md-left">{{ $galeri->keterangan }}</label>
                    </div>

                    <div class="form-group row">
                        <label for="judul" class="col-md-3 col-form-label text-md-right">Content</label>
                        <label for="judul" class="col-md-6 col-form-label text-md-left">{{ $galeri->path }}</label>
                    </div>
